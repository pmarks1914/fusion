...
def test_recognition_rate(test_directory):
    ...
    # SD
    # classifier = joblib.load("sd_3_train_without_orb_algo_zscore_on_svm_classifier_jaffe.joblib")
    # SI 
        ...
        for filename in filenames:
            ...
            if (img_extention == ".jpg" or img_extention == ".png"):  # Check if the image is successfully loaded
                ...
                if len(features) > 0:
                    ...
                    destination_dir = f'./mmi-emotion-model/{predicted_label[0]}/'
                    print("destination >> ", destination_dir, " << source >>", source_file)
                    if predicted_label[0] == "anger":
                        shutil.copy2(source_file, destination_dir)
                        pass
                    elif predicted_label[0] == "sadness":
                        shutil.copy2(source_file, destination_dir)
                        pass
                    elif predicted_label[0] == "neutral":
                        shutil.copy(source_file, destination_dir)
                        pass
                    elif predicted_label[0] == "disgust":
                        shutil.copy2(source_file, destination_dir)
                        pass
                    elif predicted_label[0] == "fear":
                        shutil.copy2(source_file, destination_dir)
                        pass
                    elif predicted_label[0] == "happy":
                        shutil.copy2(source_file, destination_dir)
                        pass
                    elif predicted_label[0] == "surprise":
                        shutil.copy2(source_file, destination_dir)
                        pass
                    else:
                        print("un >>> ", destination_dir)
                        destination_dir = os.path.join(f'./mmi-emotion-model/un', f'{img_name}{img_extention}')
                        shutil.copy2(source_file, destination_dir)
                        pass
                    # Append the predicted label and ground truth label
                    predicted_labels.append(predicted_label[0])
                    print("<--3-->", predicted_label[0], " >< ", dirname.split(os.sep)[-1], " <> ", dirname.split(os.sep) )
